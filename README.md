...
| <a name="input_node_pools"></a> [node\_pools](#input\_node\_pools) | List of node pools. For parameter details refer to node\_pool variable table below | `any` | <pre>[<br>  {<br>    "name": "default-node-pool"<br>  }<br>]</pre> | no |
