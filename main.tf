    ...
    dynamic "guest_accelerator" {
      ...
      content {
        ...
        dynamic "gpu_driver_installation_config" {
          for_each = lookup(each.value["guest_accelerator"], "gpu_driver_installation_config", null) != null ? [1] : []
          content {
            gpu_driver_version = lookup(gpu_driver_installation_config.value, "gpu_driver_version", "DEFAULT")
          }
        }
